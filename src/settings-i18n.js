...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      sidebarCompanion: "Companion",
      companionTitle: "Companion Watcher",
      companionSubtitle: "Status, break reminders, and stats for the games/music/video/meeting companion add-on.",
      companionSectionStatus: "Status",
      companionSectionSettings: "Settings",
      companionSectionPhoneSync: "Phone Sync",
      companionPhoneSyncDesc: "Mirror your companion live on an Android app over your own free Cloudflare relay. Off by default — see cloud/README.md to deploy your relay first.",
      rowCloudSyncEnabled: "Enable phone sync",
      rowCloudSyncEnabledDesc: "Push live companion state to the relay so the Android app can mirror it.",
      rowCloudRelayUrl: "Relay URL",
      rowCloudRelayUrlDesc: "Your deployed Cloudflare Worker URL (see cloud/README.md).",
      rowCloudSyncCode: "Pairing code",
      rowCloudSyncCodeDesc: "Enter this code once in the Android app to link it to this desktop.",
      cloudSyncCodeNone: "No code yet",
      actionSave: "Save",
      actionCopy: "Copy",
      actionCopied: "Copied!",
      actionGenerateSyncCode: "Generate Pairing Code",
      actionRegenerateSyncCode: "Regenerate",
      companionSectionLevel: "Level & Progress",
      companionStatLevel: "Level",
      rowCompanionAccessory: "Cosmetic accessory",
      rowCompanionAccessoryDesc: "Purely for fun — unlocks as your companion levels up. Only visible on themes that support it (Cozy Cat).",
      companionAccessoryNone: "None",
      companionAccessoryPartyHat: "🎉 Party Hat",
      companionAccessorySunglasses: "😎 Sunglasses",
      companionSectionStats: "Stats",
      rowCompanionStatus: "Watcher status",
      companionStatusLoading: "Checking…",
      companionStatusRunning: "Running",
      companionStatusStopped: "Not running",
      rowCompanionRestart: "Restart watcher",
      rowCompanionRestartDesc: "Stop and start the companion watcher again — useful after editing a config file or if it seems stuck.",
      actionCompanionRestart: "Restart",
      companionRestarting: "Restarting…",
      companionRestarted: "Companion watcher restarted",
      rowCompanionConfigFolder: "Edit game/meeting lists",
      rowCompanionConfigFolderDesc: "Open the scripts folder containing games.config.json and meeting-apps.config.json.",
      actionCompanionOpenFolder: "Open folder",
      rowCompanionBreakMinutes: "Break reminder after",
      rowCompanionBreakMinutesDesc: "Minutes of continuous gaming/meeting/video/music before a gentle “stretch your legs?” nudge.",
      companionStatStreak: "Streak",
      companionStatDays: "day(s)",
      companionStatLastActive: "last active",
      companionStatToday: "Today",
      companionStatWeek: "Last 7 days",
      companionActivityGaming: "Gaming",
      companionActivityMeeting: "Meetings",
      companionActivityVideo: "Video",
      companionActivityMusic: "Music",
      companionActivityTyping: "Typing",
      companionStatAchievements: "Achievements",
      companionAchievementNightOwl: "🦉 Night Owl",
      companionAchievementEarlyBird: "🐦 Early Bird",
      companionAchievementMarathon: "🏃 Marathon",
      companionStatLongestSession: "longest session",
      companionStatNoAchievementsYet: "None yet",
      unitMinutesShort: "m",
      unitHoursShort: "h",
      ...
      telegramCompanionAlerts: "Companion streak/break alerts",
      telegramCompanionAlertsDesc: "Also DM you via this bot when the companion watcher hits a streak milestone, a break reminder, or an achievement. Requires Telegram approvals to be set up and active above.",
      ...
      rowCompanionWatcherAutoStart: "Auto-start companion watcher",
      rowCompanionWatcherAutoStartDesc: "Run the games/music/video/meeting companion script in the background whenever Clawd is running, instead of starting it by hand.",
    ...
    zh: {
      ...
      sidebarCompanion: "伴侣",
      companionTitle: "伴侣监测",
      companionSubtitle: "游戏/音乐/视频/会议伴侣插件的状态、休息提醒和统计数据。",
      companionSectionStatus: "状态",
      companionSectionSettings: "设置",
      companionSectionPhoneSync: "手机同步",
      companionPhoneSyncDesc: "通过你自己的免费 Cloudflare 中继服务，将伴侣实时镜像到 Android 应用。默认关闭 —— 请先参阅 cloud/README.md 部署你的中继服务。",
      rowCloudSyncEnabled: "启用手机同步",
      rowCloudSyncEnabledDesc: "将伴侣的实时状态推送到中继服务，供 Android 应用镜像显示。",
      rowCloudRelayUrl: "中继服务地址",
      rowCloudRelayUrlDesc: "你部署的 Cloudflare Worker 地址（参阅 cloud/README.md）。",
      rowCloudSyncCode: "配对码",
      rowCloudSyncCodeDesc: "在 Android 应用中输入一次此配对码，即可将其与本电脑关联。",
      cloudSyncCodeNone: "尚无配对码",
      actionSave: "保存",
      actionCopy: "复制",
      actionCopied: "已复制！",
      actionGenerateSyncCode: "生成配对码",
      actionRegenerateSyncCode: "重新生成",
      companionSectionLevel: "等级与进度",
      companionStatLevel: "等级",
      rowCompanionAccessory: "外观装饰",
      rowCompanionAccessoryDesc: "纯属娱乐 —— 随着伴侣升级解锁。仅在支持的主题（Cozy Cat）中可见。",
      companionAccessoryNone: "无",
      companionAccessoryPartyHat: "🎉 派对帽",
      companionAccessorySunglasses: "😎 墨镜",
      companionSectionStats: "统计",
      rowCompanionStatus: "监测脚本状态",
      companionStatusLoading: "检查中…",
      companionStatusRunning: "运行中",
      companionStatusStopped: "未运行",
      rowCompanionRestart: "重启监测脚本",
      rowCompanionRestartDesc: "停止并重新启动伴侣监测脚本——编辑配置文件后或脚本卡住时很有用。",
      actionCompanionRestart: "重启",
      companionRestarting: "重启中…",
      companionRestarted: "伴侣监测脚本已重启",
      rowCompanionConfigFolder: "编辑游戏/会议列表",
      rowCompanionConfigFolderDesc: "打开包含 games.config.json 和 meeting-apps.config.json 的 scripts 文件夹。",
      actionCompanionOpenFolder: "打开文件夹",
      rowCompanionBreakMinutes: "休息提醒间隔",
      rowCompanionBreakMinutesDesc: "连续游戏/会议/视频/音乐达到这么多分钟后，温和提醒“休息一下？”。",
      companionStatStreak: "连续记录",
      companionStatDays: "天",
      companionStatLastActive: "上次活跃",
      companionStatToday: "今天",
      companionStatWeek: "最近 7 天",
      companionActivityGaming: "游戏",
      companionActivityMeeting: "会议",
      companionActivityVideo: "视频",
      companionActivityMusic: "音乐",
      companionActivityTyping: "打字",
      companionStatAchievements: "成就",
      companionAchievementNightOwl: "🦉 夜猫子",
      companionAchievementEarlyBird: "🐦 早起鸟",
      companionAchievementMarathon: "🏃 马拉松",
      companionStatLongestSession: "最长单次时长",
      companionStatNoAchievementsYet: "尚无成就",
      unitMinutesShort: "分",
      unitHoursShort: "小时",
      ...
      telegramCompanionAlerts: "伴侣连续记录/休息提醒",
      telegramCompanionAlertsDesc: "当伴侣监测脚本达到连续记录里程碑、休息提醒或成就时，也通过此机器人给你发消息。需要上面的 Telegram 审批已设置并处于活动状态。",
      ...
      rowCompanionWatcherAutoStart: "自动启动伴侣监测脚本",
      rowCompanionWatcherAutoStartDesc: "只要 Clawd 在运行，就在后台自动运行游戏/音乐/视频/会议监测脚本，无需手动启动。",
    ...
    "zh-TW": {
      ...
      sidebarCompanion: "夥伴",
      companionTitle: "夥伴監測",
      companionSubtitle: "遊戲／音樂／影片／會議夥伴外掛的狀態、休息提醒和統計資料。",
      companionSectionStatus: "狀態",
      companionSectionSettings: "設定",
      companionSectionPhoneSync: "手機同步",
      companionPhoneSyncDesc: "透過你自己的免費 Cloudflare 中繼服務，將夥伴即時鏡像到 Android 應用程式。預設關閉 —— 請先參閱 cloud/README.md 部署你的中繼服務。",
      rowCloudSyncEnabled: "啟用手機同步",
      rowCloudSyncEnabledDesc: "將夥伴的即時狀態推送到中繼服務，供 Android 應用程式鏡像顯示。",
      rowCloudRelayUrl: "中繼服務網址",
      rowCloudRelayUrlDesc: "你部署的 Cloudflare Worker 網址（參閱 cloud/README.md）。",
      rowCloudSyncCode: "配對碼",
      rowCloudSyncCodeDesc: "在 Android 應用程式中輸入一次此配對碼，即可將其與這台電腦連結。",
      cloudSyncCodeNone: "尚無配對碼",
      actionSave: "儲存",
      actionCopy: "複製",
      actionCopied: "已複製！",
      actionGenerateSyncCode: "產生配對碼",
      actionRegenerateSyncCode: "重新產生",
      companionSectionLevel: "等級與進度",
      companionStatLevel: "等級",
      rowCompanionAccessory: "外觀裝飾",
      rowCompanionAccessoryDesc: "純屬娛樂 —— 隨著夥伴升級解鎖。僅在支援的主題（Cozy Cat）中可見。",
      companionAccessoryNone: "無",
      companionAccessoryPartyHat: "🎉 派對帽",
      companionAccessorySunglasses: "😎 墨鏡",
      companionSectionStats: "統計",
      rowCompanionStatus: "監測腳本狀態",
      companionStatusLoading: "檢查中…",
      companionStatusRunning: "執行中",
      companionStatusStopped: "未執行",
      rowCompanionRestart: "重新啟動監測腳本",
      rowCompanionRestartDesc: "停止並重新啟動夥伴監測腳本——編輯設定檔後或腳本卡住時很有用。",
      actionCompanionRestart: "重新啟動",
      companionRestarting: "重新啟動中…",
      companionRestarted: "夥伴監測腳本已重新啟動",
      rowCompanionConfigFolder: "編輯遊戲／會議清單",
      rowCompanionConfigFolderDesc: "開啟包含 games.config.json 與 meeting-apps.config.json 的 scripts 資料夾。",
      actionCompanionOpenFolder: "開啟資料夾",
      rowCompanionBreakMinutes: "休息提醒間隔",
      rowCompanionBreakMinutesDesc: "連續遊戲／會議／影片／音樂達到這麼多分鐘後，溫和提醒「休息一下？」。",
      companionStatStreak: "連續記錄",
      companionStatDays: "天",
      companionStatLastActive: "上次活躍",
      companionStatToday: "今天",
      companionStatWeek: "最近 7 天",
      companionActivityGaming: "遊戲",
      companionActivityMeeting: "會議",
      companionActivityVideo: "影片",
      companionActivityMusic: "音樂",
      companionActivityTyping: "打字",
      companionStatAchievements: "成就",
      companionAchievementNightOwl: "🦉 夜貓子",
      companionAchievementEarlyBird: "🐦 早起鳥",
      companionAchievementMarathon: "🏃 馬拉松",
      companionStatLongestSession: "最長單次時長",
      companionStatNoAchievementsYet: "尚無成就",
      unitMinutesShort: "分",
      unitHoursShort: "小時",
      ...
      telegramCompanionAlerts: "夥伴連續記錄／休息提醒",
      telegramCompanionAlertsDesc: "當夥伴監測腳本達到連續記錄里程碑、休息提醒或成就時，也透過這個機器人傳訊息給你。需要上面的 Telegram 審批已設定並啟用。",
      ...
      rowCompanionWatcherAutoStart: "自動啟動夥伴監測腳本",
      rowCompanionWatcherAutoStartDesc: "只要 Clawd 在執行，就在背景自動執行遊戲／音樂／影片／會議監測腳本，不必手動啟動。",
    ...
    ko: {
      ...
      sidebarCompanion: "컴패니언",
      companionTitle: "컴패니언 감시",
      companionSubtitle: "게임/음악/영상/회의 컴패니언 애드온의 상태, 휴식 알림, 통계입니다.",
      companionSectionStatus: "상태",
      companionSectionSettings: "설정",
      companionSectionPhoneSync: "폰 동기화",
      companionPhoneSyncDesc: "무료 Cloudflare 릴레이를 통해 컴패니언을 Android 앱에 실시간으로 미러링합니다. 기본적으로 꺼져 있음 — 먼저 cloud/README.md를 참고해 릴레이를 배포하세요.",
      rowCloudSyncEnabled: "폰 동기화 사용",
      rowCloudSyncEnabledDesc: "Android 앱이 미러링할 수 있도록 컴패니언의 실시간 상태를 릴레이로 전송합니다.",
      rowCloudRelayUrl: "릴레이 URL",
      rowCloudRelayUrlDesc: "배포한 Cloudflare Worker URL입니다 (cloud/README.md 참고).",
      rowCloudSyncCode: "페어링 코드",
      rowCloudSyncCodeDesc: "Android 앱에 이 코드를 한 번 입력하면 이 데스크톱과 연결됩니다.",
      cloudSyncCodeNone: "아직 코드 없음",
      actionSave: "저장",
      actionCopy: "복사",
      actionCopied: "복사됨!",
      actionGenerateSyncCode: "페어링 코드 생성",
      actionRegenerateSyncCode: "재생성",
      companionSectionLevel: "레벨 및 진행도",
      companionStatLevel: "레벨",
      rowCompanionAccessory: "코스메틱 액세서리",
      rowCompanionAccessoryDesc: "순수하게 재미를 위한 기능 — 컴패니언 레벨이 오르면 해제됩니다. 지원하는 테마(Cozy Cat)에서만 표시됩니다.",
      companionAccessoryNone: "없음",
      companionAccessoryPartyHat: "🎉 파티 모자",
      companionAccessorySunglasses: "😎 선글라스",
      companionSectionStats: "통계",
      rowCompanionStatus: "감시 스크립트 상태",
      companionStatusLoading: "확인 중…",
      companionStatusRunning: "실행 중",
      companionStatusStopped: "실행되지 않음",
      rowCompanionRestart: "감시 스크립트 재시작",
      rowCompanionRestartDesc: "컴패니언 감시 스크립트를 중지했다가 다시 시작합니다 — 설정 파일을 수정했거나 멈춘 것 같을 때 유용합니다.",
      actionCompanionRestart: "재시작",
      companionRestarting: "재시작 중…",
      companionRestarted: "컴패니언 감시 스크립트가 재시작되었습니다",
      rowCompanionConfigFolder: "게임/회의 목록 편집",
      rowCompanionConfigFolderDesc: "games.config.json과 meeting-apps.config.json이 있는 scripts 폴더를 엽니다.",
      actionCompanionOpenFolder: "폴더 열기",
      rowCompanionBreakMinutes: "휴식 알림 간격",
      rowCompanionBreakMinutesDesc: "게임/회의/영상/음악이 이 시간(분) 동안 계속되면 부드럽게 '스트레칭 어때요?'라고 알려줍니다.",
      companionStatStreak: "연속 기록",
      companionStatDays: "일",
      companionStatLastActive: "마지막 활동",
      companionStatToday: "오늘",
      companionStatWeek: "최근 7일",
      companionActivityGaming: "게임",
      companionActivityMeeting: "회의",
      companionActivityVideo: "영상",
      companionActivityMusic: "음악",
      companionActivityTyping: "타이핑",
      companionStatAchievements: "업적",
      companionAchievementNightOwl: "🦉 올빼미족",
      companionAchievementEarlyBird: "🐦 얼리버드",
      companionAchievementMarathon: "🏃 마라톤",
      companionStatLongestSession: "최장 세션",
      companionStatNoAchievementsYet: "아직 없음",
      unitMinutesShort: "분",
      unitHoursShort: "시간",
      ...
      telegramCompanionAlerts: "컴패니언 스트릭/휴식 알림",
      telegramCompanionAlertsDesc: "컴패니언 감시 스크립트가 스트릭 마일스톤, 휴식 알림, 업적에 도달하면 이 봇으로도 DM을 보냅니다. 위의 Telegram 승인이 설정되어 활성화되어 있어야 합니다.",
      ...
      rowCompanionWatcherAutoStart: "컴패니언 감시 스크립트 자동 시작",
      rowCompanionWatcherAutoStartDesc: "Clawd가 실행되는 동안 게임/음악/영상/회의 감시 스크립트를 백그라운드에서 자동으로 실행합니다. 직접 시작할 필요가 없습니다.",
    ...
    ja: {
      ...
      sidebarCompanion: "コンパニオン",
      companionTitle: "コンパニオン監視",
      companionSubtitle: "ゲーム/音楽/動画/会議コンパニオンアドオンの状態、休憩リマインダー、統計です。",
      companionSectionStatus: "状態",
      companionSectionSettings: "設定",
      companionSectionPhoneSync: "スマホ同期",
      companionPhoneSyncDesc: "自分の無料 Cloudflare リレー経由で、コンパニオンを Android アプリにライブでミラーリングします。デフォルトはオフです — まず cloud/README.md を参照してリレーをデプロイしてください。",
      rowCloudSyncEnabled: "スマホ同期を有効化",
      rowCloudSyncEnabledDesc: "Android アプリがミラーリングできるよう、コンパニオンのライブ状態をリレーに送信します。",
      rowCloudRelayUrl: "リレー URL",
      rowCloudRelayUrlDesc: "デプロイした Cloudflare Worker の URL です（cloud/README.md を参照）。",
      rowCloudSyncCode: "ペアリングコード",
      rowCloudSyncCodeDesc: "Android アプリにこのコードを一度入力すると、このデスクトップと連携します。",
      cloudSyncCodeNone: "コードはまだありません",
      actionSave: "保存",
      actionCopy: "コピー",
      actionCopied: "コピーしました！",
      actionGenerateSyncCode: "ペアリングコードを生成",
      actionRegenerateSyncCode: "再生成",
      companionSectionLevel: "レベルと進行度",
      companionStatLevel: "レベル",
      rowCompanionAccessory: "コスメティックアクセサリー",
      rowCompanionAccessoryDesc: "純粋にお楽しみ用 —— コンパニオンのレベルアップで解放されます。対応テーマ（Cozy Cat）でのみ表示されます。",
      companionAccessoryNone: "なし",
      companionAccessoryPartyHat: "🎉 パーティーハット",
      companionAccessorySunglasses: "😎 サングラス",
      companionSectionStats: "統計",
      rowCompanionStatus: "監視スクリプトの状態",
      companionStatusLoading: "確認中…",
      companionStatusRunning: "実行中",
      companionStatusStopped: "停止中",
      rowCompanionRestart: "監視スクリプトを再起動",
      rowCompanionRestartDesc: "コンパニオン監視スクリプトを停止して再起動します — 設定ファイルを編集した後や、動作が止まっているように見えるときに便利です。",
      actionCompanionRestart: "再起動",
      companionRestarting: "再起動中…",
      companionRestarted: "コンパニオン監視スクリプトを再起動しました",
      rowCompanionConfigFolder: "ゲーム/会議リストを編集",
      rowCompanionConfigFolderDesc: "games.config.json と meeting-apps.config.json がある scripts フォルダを開きます。",
      actionCompanionOpenFolder: "フォルダを開く",
      rowCompanionBreakMinutes: "休憩リマインダーの間隔",
      rowCompanionBreakMinutesDesc: "ゲーム/会議/動画/音楽がこの分数続いたら、「少し休憩しませんか？」と優しく知らせます。",
      companionStatStreak: "継続記録",
      companionStatDays: "日",
      companionStatLastActive: "最終アクティブ",
      companionStatToday: "今日",
      companionStatWeek: "直近7日間",
      companionActivityGaming: "ゲーム",
      companionActivityMeeting: "会議",
      companionActivityVideo: "動画",
      companionActivityMusic: "音楽",
      companionActivityTyping: "タイピング",
      companionStatAchievements: "実績",
      companionAchievementNightOwl: "🦉 夜型",
      companionAchievementEarlyBird: "🐦 早起き",
      companionAchievementMarathon: "🏃 マラソン",
      companionStatLongestSession: "最長セッション",
      companionStatNoAchievementsYet: "まだありません",
      unitMinutesShort: "分",
      unitHoursShort: "時間",
      ...
      telegramCompanionAlerts: "コンパニオンの継続記録/休憩通知",
      telegramCompanionAlertsDesc: "コンパニオン監視スクリプトが継続記録のマイルストーン、休憩リマインダー、実績に達したときも、このボットで DM を送ります。上の Telegram 承認が設定され有効になっている必要があります。",
      ...
      rowCompanionWatcherAutoStart: "コンパニオン監視スクリプトを自動起動",
      rowCompanionWatcherAutoStartDesc: "Clawd が起動している間、ゲーム/音楽/動画/会議の監視スクリプトをバックグラウンドで自動的に実行します。手動で起動する必要がありません。",
